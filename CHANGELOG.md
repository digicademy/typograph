...
- Custom resolver interface and registry to enable custom resolving logic from other extensions

## [1.2.0] - 2026-04-22

### Added

- TypoLink transformer for turning TypoLinks in fetched content into functional HTML links

## [1.1.0] - 2026-04-14

### Added

- ComparatorInterface for custom result set sorting via dependency injection
- `sortBy` query argument for per-request sort field selection
